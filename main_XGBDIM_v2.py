...
eta, alpha, Nb, N_iteration, C1, C0, max_N_sub_model, gstf_weight, validation_flag, validation_step, crossentropy_flag)
'''
model_path = 'D:/XGBDIM/Model64'
xgb = XGBDIM(r'F:\XGB_for_V5_6', 1, np.array([1]), np.array([2,3,4]),
                 model_path,
                 50, 6, 3, 3, 3, 3,
                 0.5, 0.05, 100, 20, 1, 1, 299, 0.3, True, 100, False)
